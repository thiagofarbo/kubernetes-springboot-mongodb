...
import com.thec.sqs.response.MessageResponse;

public class QueueService {
	
	public static MessageResponse send(final CardCreatedEvent cartaoCriadoEvent) {
		
		String queueUrl = loadConfiguration().getQueueUrl("cartao-queue").getQueueUrl();
		
		Gson gson = new Gson();
		String message = gson.toJson(cartaoCriadoEvent.getResource());
	...
	public static MessageResponse sendToDeadLetter(final CardCreatedEvent cartaoCriadoEvent) {
